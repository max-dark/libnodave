...
EXPORTSPEC connection_t __stdcall openSocket(const int port, const char * peer) {
	int res;
	SOCKET fd;
...
Version 0.8.5
	...
	2018-02-18	extern int daveDebug -> daveGetDebug()
*/
